...
def parameters(folder=''):
    ...
    pgen = {'description': 'final_run',  # description written in result file
            ...
            'start_date': '2015-01-01',  # '2011-01-01', for tests: '2020-01-01'
            'end_date': '2015-01-31', # 2017-12-31,
            #'spinup_file': r'F:\SpaFHy_2D_2021/testcase_input_202304051037_spinup.nc',
            'spinup_end': '2015-01-31',  # '2014-12-31', for tests: '2020-09-01' results after this are saved in result file
            'dt': 86400.0,
